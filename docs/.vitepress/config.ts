      ...
      '/operators/': [
        {
          ...
          collapsed: false,
          items: [
            { text: 'All Operators (Comprehensive)', link: '/guide/operators' },
            { text: 'Comparison Operators', link: '/guide/operators#comparison-operators' },
            { text: 'Array Operators', link: '/guide/operators#array-operators' },
            { text: 'String Operators', link: '/guide/operators#string-operators' },
            { text: 'Logical Operators', link: '/guide/logical-operators' },
            { text: 'Geospatial Operators', link: '/guide/geospatial-operators' },
            { text: 'DateTime Operators', link: '/guide/datetime-operators' },
            { text: 'Regex Operators', link: '/guide/regex-operators' },
