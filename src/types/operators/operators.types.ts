...
type OperatorsForType<T> =
  IsGeoPoint<T> extends true
    ? {
        $near?: import('../geospatial/geospatial').NearQuery;
        $geoBox?: import('../geospatial/geospatial').BoundingBox;
        $geoPolygon?: import('../geospatial/geospatial').PolygonQuery;
        $eq?: T;
        $ne?: T;
        $in?: T[];
        $nin?: T[];
      ...
      : T extends number
        ...
        : T extends Date
          ? {
              ...
              $in?: Date[];
              $nin?: Date[];
              $recent?: import('../datetime/datetime').RelativeTimeQuery;
              $upcoming?: import('../datetime/datetime').RelativeTimeQuery;
              $dayOfWeek?: number[];
              $timeOfDay?: import('../datetime/datetime').TimeOfDayQuery;
              $age?: import('../datetime/datetime').AgeQuery;
              $isWeekday?: boolean;
              $isWeekend?: boolean;
              $isBefore?: Date;
              $isAfter?: Date;
